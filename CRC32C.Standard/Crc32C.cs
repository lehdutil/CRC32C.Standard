...
namespace Ralph.Crc32C
{
    /// <summary>
    /// A pure-C# implementation of the CRC32 checksum that uses
    ...
    public class Crc32C
    {
        ...
        public void Update(byte[] b, int off, int len)
        {
            ...
            while (len > 7)
            {
                var c0 = b[off++] ^ localCrc;
                localCrc >>= 8;
                var c1 = b[off++] ^ localCrc;
                localCrc >>= 8;
                var c2 = b[off++] ^ localCrc;
                localCrc >>= 8;
                var c3 = b[off++] ^ localCrc;
                localCrc = T8_7[c0 & 0xff] ^ T8_6[c1 & 0xff] ^ T8_5[c2 & 0xff] ^ T8_4[c3 & 0xff];

                localCrc ^= T8_3[b[off++] & 0xff] ^ T8_2[b[off++] & 0xff] ^ T8_1[b[off++] & 0xff] ^
                            T8_0[b[off++] & 0xff];
        ...
        private static readonly uint[] T8_0 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_1 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_2 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_3 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_4 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_5 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_6 =
        {
        ...
        // ReSharper disable once InconsistentNaming
        private static readonly uint[] T8_7 =
        {
